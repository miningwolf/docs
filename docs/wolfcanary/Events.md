...
new __ConsoleCommand__(receiver, textInput) <br> _Constructs a new ConsoleCommand_ | _constructor_
 readonly property __Caller__ <br> _Get: Get the object that has issued the command._ | [`MessageReceiver`](io/wolfscript/chat/MessageReceiver.md)
...
new __PlayerDeath__(player, source, msg) <br> _Constructs a new PlayerDeath_ | _constructor_
 readonly property __DamageSource__ <br> _Get: Gets the [`ChatComponent`](io/wolfscript/api/chat/ChatComponent.md) containing the death message_ | [`DamageSource`](io/wolfscript/api/DamageSource.md)
...
new __Ignition__(ignited, player, clicked, cause) <br> _Ignition constructor_ | _constructor_
 readonly property __Block__ <br> _Get: Gets the [`Block`](io/wolfscript/api/world/blocks/Block.md) that is about to go up in flames_ | [`Block`](io/wolfscript/api/world/blocks/Block.md)
...
new __ArmorBroken__(player, armor) <br> _ArmorBroken constructor_ | _constructor_
 readonly property __Armor__ <br> _Get: Gets the armor that was broken<p/>_ | [`Item`](io/wolfscript/api/inventory/Item.md)
...
Called when a @{link Player} places/replaces armor in an [`entity.ArmorStand`](io/wolfscript/api/entity/ArmorStand.md)
...
new __ArmorStandModify__(armorStand, player, slotId, current, setting) <br> _ArmorStandModify constructor_ | _constructor_
 ...
 readonly property __SettingItem__ <br> _Get: Gets the [`Item`](io/wolfscript/api/inventory/Item.md) being set in the ArmorStand_ | [`Item`](io/wolfscript/api/inventory/Item.md)
...
new __Ban__(banned, ip, moderator, reason, bantime) <br> _Ban constructor_ | _constructor_
 readonly property __BannedPlayer__ <br> _Get: Get the [`PlayerReference`](io/wolfscript/api/PlayerReference.md) that has been banned._ | [`PlayerReference`](io/wolfscript/api/PlayerReference.md)
...
new __ItemFrameRotate__(player, itemFrame) <br> _ItemFrameRotate constructor_ | _constructor_
 readonly property __CurrentRotation__ <br> _Get: Gets the current rotation of the [`Item`](io/wolfscript/api/inventory/Item.md) in the [`ItemFrame`](io/wolfscript/api/entity/hanging/ItemFrame.md)_ | `int`
