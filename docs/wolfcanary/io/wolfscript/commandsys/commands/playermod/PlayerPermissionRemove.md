## PlayerPermissionRemove __class__

>io.wolfscript.commandsys.commands.playermod.PlayerPermissionRemove
...
### Public Methods for [`PlayerPermissionRemove`](PlayerPermissionRemove.md)
