## PlayerPermissionCheck __class__

>io.wolfscript.commandsys.commands.playermod.PlayerPermissionCheck
...
### Public Methods for [`PlayerPermissionCheck`](PlayerPermissionCheck.md)
