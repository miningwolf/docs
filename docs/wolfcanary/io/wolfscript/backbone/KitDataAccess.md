...
new __KitDataAccess__() <br> _KitDataAccess constructor_ | _constructor_
 ...
 var __useDelay__ <br> _Delay in seconds to receive this kit._ | `int`
 var __owners__ <br> _List of Users names who can use this kit._ | `List<String>`
 var __groups__ <br> _List of groups who can use this kit._ | `List<String>`
 var __name__ <br> _Name of this kit._ | `String`
 var __items__ <br> _Items to give from this kit._ | `List<String>`
 |
...
##### <a id='usedelay'></a>public  var __useDelay__

_Delay in seconds to receive this kit._

>Returns
>  `int`

##### <a id='owners'></a>public  var __owners__

_List of Users names who can use this kit._
...
_List of groups who can use this kit._
...
_Items to give from this kit._
