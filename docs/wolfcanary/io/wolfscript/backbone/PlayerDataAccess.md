...
final function __toString__() <br> _toString method_ | `String`
 var __group__ <br> _Player uuid for this ban._ | `String`
 var __isMuted__ <br> _Is this player muted?_ | `boolean`
 var __subgroups__ <br> _A list of additional sub groups._ | `List<String>`
 |
...
##### <a id='group'></a>public  var __group__
...
##### <a id='ismuted'></a>public  var __isMuted__

_Is this player muted?_
...
_A list of additional sub groups. Permissions will be solved according to first to come, first to rule. Unless specified otherwise, a players color will be the one of the main group_
