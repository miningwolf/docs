...
>io.wolfscript.event.player.EntityRightClickEvent
...
### Public Properties for [`EntityRightClickEvent`](EntityRightClickEvent.md)
...
### Public Methods for [`EntityRightClickEvent`](EntityRightClickEvent.md)
