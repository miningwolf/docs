...
>io.wolfscript.event.player.FoodSaturationEvent
...
### Public Properties for [`FoodSaturationEvent`](FoodSaturationEvent.md)
...
### Public Methods for [`FoodSaturationEvent`](FoodSaturationEvent.md)
