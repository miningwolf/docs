...
>io.wolfscript.event.player.ItemFrameSetItemEvent
...
### Public Properties for [`ItemFrameSetItemEvent`](ItemFrameSetItemEvent.md)
...
### Public Methods for [`ItemFrameSetItemEvent`](ItemFrameSetItemEvent.md)
