...
Method | Type   
--- | :--- 
 readonly property __EntityHit__ <br> _Get: Constructs a new ProjectileHit_ | [`Entity`](..\..\api\entity\Entity.md)
...
_Get: Constructs a new ProjectileHit_
...
[`Entity`](..\..\api\entity\Entity.md) | the projectile /
    ...
    /** Gets the [`Entity`](..\..\api\entity\Entity.md) hit by the projectile
