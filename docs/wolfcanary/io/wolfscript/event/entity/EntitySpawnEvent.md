...
>io.wolfscript.event.entity.EntitySpawnEvent
...
### Public Properties for [`EntitySpawnEvent`](EntitySpawnEvent.md)
...
### Public Methods for [`EntitySpawnEvent`](EntitySpawnEvent.md)
