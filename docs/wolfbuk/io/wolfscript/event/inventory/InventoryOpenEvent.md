...
### Public Constructors for [`InventoryOpenEvent`](InventoryOpenEvent.md)

##### <a id='inventoryopenevent'></a>new __InventoryOpenEvent__(transaction) 

_InventoryOpenEvent constructor_
...
### Public Properties for [`InventoryOpenEvent`](InventoryOpenEvent.md)
