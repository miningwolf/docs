...
>io.wolfscript.event.vehicle.VehicleDestroyEvent
...
### Public Constructors for [`VehicleDestroyEvent`](VehicleDestroyEvent.md)

##### <a id='vehicledestroyevent'></a>new __VehicleDestroyEvent__(Vehicle, Entity) 

_VehicleDestroyEvent constructor_
...
_Get: Gets the Entity that has destroyed the vehicle, potentially null_

Get | Description
--- | --- 
`Entity` | the Entity that has destroyed the vehicle, potentially null
