...
### Public Constructors for [`WorldInitEvent`](WorldInitEvent.md)

##### <a id='worldinitevent'></a>new __WorldInitEvent__(World) 

_WorldInitEvent constructor_
...
### Public Properties for [`WorldInitEvent`](WorldInitEvent.md)
