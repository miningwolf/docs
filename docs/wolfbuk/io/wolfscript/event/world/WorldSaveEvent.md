## WorldSaveEvent __class__

>io.wolfscript.event.world.WorldSaveEvent
...
### Public Constructors for [`WorldSaveEvent`](WorldSaveEvent.md)

##### <a id='worldsaveevent'></a>new __WorldSaveEvent__(World) 

_WorldSaveEvent constructor_
...
### Public Properties for [`WorldSaveEvent`](WorldSaveEvent.md)
