...
### Public Constructors for [`ChunkLoadEvent`](ChunkLoadEvent.md)

##### <a id='chunkloadevent'></a>new __ChunkLoadEvent__(Chunk, boolean) 

_ChunkLoadEvent constructor_
...
### Public Properties for [`ChunkLoadEvent`](ChunkLoadEvent.md)
...
### Public Methods for [`ChunkLoadEvent`](ChunkLoadEvent.md)

##### <a id='isnewchunk'></a>public  function __isNewChunk__()

_Gets if this chunk was newly created or not. <p> Note that if this chunk is new, it will not be populated at this time._

Returns | Description
--- | --- 
`boolean` | true if the chunk is new, otherwise false
