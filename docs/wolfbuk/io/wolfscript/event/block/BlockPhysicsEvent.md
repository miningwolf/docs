...
Method | Type   
--- | :--- 
 readonly property __ChangedType__ <br> _Get: Gets the type of block that changed, causing this event_ | [`Material`](../../Material.md)
...
### Public Constructors for [`BlockPhysicsEvent`](BlockPhysicsEvent.md)

##### <a id='blockphysicsevent'></a>new __BlockPhysicsEvent__(Block, int) 
_Deprecated: Magic value_

_BlockPhysicsEvent constructor_
...
### Public Properties for [`BlockPhysicsEvent`](BlockPhysicsEvent.md)

##### <a id='changedtype'></a>public  readonly property __ChangedType__

_Get: Gets the type of block that changed, causing this event_

Get | Description
--- | --- 
[`Material`](../../Material.md) | Changed block's type



##### <a id='changedtypeid'></a>public  readonly property __ChangedTypeId__
_Deprecated: Magic value_
...
### Public Methods for [`BlockPhysicsEvent`](BlockPhysicsEvent.md)
