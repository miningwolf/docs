## SheepRegrowWoolEvent __class__

>io.wolfscript.event.entity.SheepRegrowWoolEvent
...
### Public Constructors for [`SheepRegrowWoolEvent`](SheepRegrowWoolEvent.md)

##### <a id='sheepregrowwoolevent'></a>new __SheepRegrowWoolEvent__(Sheep) 

_SheepRegrowWoolEvent constructor_
...
### Public Properties for [`SheepRegrowWoolEvent`](SheepRegrowWoolEvent.md)
...
### Public Methods for [`SheepRegrowWoolEvent`](SheepRegrowWoolEvent.md)
