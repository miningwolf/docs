...
##### <a id='duration'></a>public  writeonly property __Duration__

_Duration property_

Get | Description
--- | --- 
`void` | the amount of time (in seconds) the combustee should be alight for /
