## EntityPortalEnterEvent __class__
...
### Public Constructors for [`EntityPortalEnterEvent`](EntityPortalEnterEvent.md)

##### <a id='entityportalenterevent'></a>new __EntityPortalEnterEvent__(Entity, Location) 

_EntityPortalEnterEvent constructor_
...
### Public Properties for [`EntityPortalEnterEvent`](EntityPortalEnterEvent.md)
...
_Get: Gets the portal block the entity is touching_

Get | Description
--- | --- 
`Location` | The portal block the entity is touching
