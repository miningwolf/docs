...
##### <a id='count'></a>public   property __Count__

_Get: Gets the amount of smaller slimes to spawn<br>Set: Sets how many smaller slimes will spawn on the split_

Get | Description
--- | --- 
`int` | the amount of slimes to spawn
