...
##### <a id='yield'></a>public  writeonly property __Yield__

_Set: Returns the list of blocks that would have been removed or were removed from the explosion event._

Get | Description
--- | --- 
`void` | All blown-up blocks /
