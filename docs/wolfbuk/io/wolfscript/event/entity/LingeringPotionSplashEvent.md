## LingeringPotionSplashEvent __class__

>io.wolfscript.event.entity.LingeringPotionSplashEvent
...
new __LingeringPotionSplashEvent__(ThrownPotion, AreaEffectCloud) <br> _LingeringPotionSplashEvent constructor_ | _constructor_
 readonly property __AreaEffectCloud__ <br> _Get: Gets the AreaEffectCloud spawned_ | [`AreaEffectCloud`](../../entity/AreaEffectCloud.md)
 readonly property __Entity__ <br> _Entity property_ | [`LingeringPotion`](../../entity/LingeringPotion.md)
...
### Public Constructors for [`LingeringPotionSplashEvent`](LingeringPotionSplashEvent.md)

##### <a id='lingeringpotionsplashevent'></a>new __LingeringPotionSplashEvent__(ThrownPotion, AreaEffectCloud) 

_LingeringPotionSplashEvent constructor_
...
### Public Properties for [`LingeringPotionSplashEvent`](LingeringPotionSplashEvent.md)

##### <a id='areaeffectcloud'></a>public  readonly property __AreaEffectCloud__

_Get: Gets the AreaEffectCloud spawned_

Get | Description
--- | --- 
[`AreaEffectCloud`](../../entity/AreaEffectCloud.md) | The spawned AreaEffectCloud
...
Get | 
--- | 
[`LingeringPotion`](../../entity/LingeringPotion.md) |
...
### Public Methods for [`LingeringPotionSplashEvent`](LingeringPotionSplashEvent.md)
