...
##### <a id='bow'></a>public  readonly property __Bow__

_Get: Gets the bow ItemStack used to fire the arrow._

Get | Description
--- | --- 
`ItemStack` | the bow involved in this event
...
_Get: Gets the force the arrow was launched with_

Get | Description
--- | --- 
`float` | bow shooting force, up to 1.0
...
##### <a id='projectile'></a>public   property __Projectile__

_Get: Gets the projectile which will be launched by this event<br>Set: Replaces the projectile which will be launched_

Get | Description
--- | --- 
`Entity` | the launched projectile

Set | Type | Description  
--- | --- | --- 
projectile | `Entity` | the new projectile
