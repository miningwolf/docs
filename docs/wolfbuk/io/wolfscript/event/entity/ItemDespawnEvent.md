## ItemDespawnEvent __class__

>io.wolfscript.event.entity.ItemDespawnEvent
...
This event is called when a [`Item`](../../entity/Item.md) is removed from the world because it has existed for 5 minutes. <p> Cancelling the event results in the item being allowed to exist for 5 more minutes. This behavior is not guaranteed and may change in future versions.
...
### Public Constructors for [`ItemDespawnEvent`](ItemDespawnEvent.md)

##### <a id='itemdespawnevent'></a>new __ItemDespawnEvent__(Item, Location) 

_ItemDespawnEvent constructor_
...
### Public Properties for [`ItemDespawnEvent`](ItemDespawnEvent.md)
...
_Get: Gets the location at which the item is despawning._

Get | Description
--- | --- 
`Location` | The location at which the item is despawning
...
### Public Methods for [`ItemDespawnEvent`](ItemDespawnEvent.md)
