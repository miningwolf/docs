## PlayerToggleSneakEvent __class__

>io.wolfscript.event.player.PlayerToggleSneakEvent
...
### Public Constructors for [`PlayerToggleSneakEvent`](PlayerToggleSneakEvent.md)

##### <a id='playertogglesneakevent'></a>new __PlayerToggleSneakEvent__(Player, boolean) 

_PlayerToggleSneakEvent constructor_
...
### Public Properties for [`PlayerToggleSneakEvent`](PlayerToggleSneakEvent.md)
...
### Public Methods for [`PlayerToggleSneakEvent`](PlayerToggleSneakEvent.md)
...
##### <a id='issneaking'></a>public  function __isSneaking__()
