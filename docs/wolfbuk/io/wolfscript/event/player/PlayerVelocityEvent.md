...
_Get: Gets the velocity vector that will be sent to the player<br>Set: Sets the velocity vector that will be sent to the player_

Get | Description
--- | --- 
`Vector` | Vector the player will get
