...
##### <a id='quitmessage'></a>public   property __QuitMessage__

_Get: Gets the quit message to send to all online players<br>Set: Sets the quit message to send to all online players_

Get | Description
--- | --- 
`String` | string quit message
