...
##### <a id='joinmessage'></a>public   property __JoinMessage__

_Get: Gets the join message to send to all online players<br>Set: Sets the join message to send to all online players_
