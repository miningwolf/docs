## PlayerChangedWorldEvent __class__
...
### Public Constructors for [`PlayerChangedWorldEvent`](PlayerChangedWorldEvent.md)

##### <a id='playerchangedworldevent'></a>new __PlayerChangedWorldEvent__(Player, World) 

_PlayerChangedWorldEvent constructor_
...
### Public Properties for [`PlayerChangedWorldEvent`](PlayerChangedWorldEvent.md)

##### <a id='from'></a>public  readonly property __From__

_Get: Gets the world the player is switching from._

Get | Description
--- | --- 
`World` |  player's previous world
