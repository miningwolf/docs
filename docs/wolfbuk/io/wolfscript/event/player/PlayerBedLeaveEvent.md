...
### Public Constructors for [`PlayerBedLeaveEvent`](PlayerBedLeaveEvent.md)

##### <a id='playerbedleaveevent'></a>new __PlayerBedLeaveEvent__(Player, Block) 

_PlayerBedLeaveEvent constructor_
...
### Public Properties for [`PlayerBedLeaveEvent`](PlayerBedLeaveEvent.md)
