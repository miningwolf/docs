## PlayerLevelChangeEvent __class__

>io.wolfscript.event.player.PlayerLevelChangeEvent
...
### Public Constructors for [`PlayerLevelChangeEvent`](PlayerLevelChangeEvent.md)

##### <a id='playerlevelchangeevent'></a>new __PlayerLevelChangeEvent__(Player, int, int) 

_PlayerLevelChangeEvent constructor_
...
### Public Properties for [`PlayerLevelChangeEvent`](PlayerLevelChangeEvent.md)
...
_Get: Gets the new level of the player_

Get | Description
--- | --- 
`int` | The new (current) level of the player



##### <a id='oldlevel'></a>public  readonly property __OldLevel__

_Get: Gets the old level of the player_

Get | Description
--- | --- 
`int` | The old level of the player
