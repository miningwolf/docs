## PlayerToggleFlightEvent __class__

>io.wolfscript.event.player.PlayerToggleFlightEvent
...
### Public Constructors for [`PlayerToggleFlightEvent`](PlayerToggleFlightEvent.md)

##### <a id='playertoggleflightevent'></a>new __PlayerToggleFlightEvent__(Player, boolean) 

_PlayerToggleFlightEvent constructor_
...
### Public Properties for [`PlayerToggleFlightEvent`](PlayerToggleFlightEvent.md)
...
### Public Methods for [`PlayerToggleFlightEvent`](PlayerToggleFlightEvent.md)
...
##### <a id='isflying'></a>public  function __isFlying__()

_Returns whether the player is trying to start or stop flying._
