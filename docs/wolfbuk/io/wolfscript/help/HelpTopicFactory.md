...
__Inherited items from [`Command`](../command/Command.md)__ |
 ...
 writeonly property __Description__ <br> _Description property_ | [`Command`](../command/Command.md)
...
static function __broadcastCommandMessage__(source, message) <br> _broadcastCommandMessage method_ | `void`
 ...
 function __setAliases__() <br> _setAliases method_ | [`Command`](../command/Command.md)
