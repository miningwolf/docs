...
__Inherited items from [`Command`](../command/Command.md)__ |
 ...
 writeonly property __Description__ <br> _Set: Sets a brief description of this command. Defining a description in the_ | [`Command`](../command/Command.md)
...
static function __broadcastCommandMessage__(source, message) <br> _broadcastCommandMessage method_ | `void`
 ...
 function __setAliases__() <br> _Sets the list of aliases to request on registration for this command._ | [`Command`](../command/Command.md)
 function __testPermission__(target) <br> _Tests the given [`CommandSender`](../command/CommandSender.md) to see if they can perform this_ | `boolean`
 function __testPermissionSilent__(target) <br> _Tests the given [`CommandSender`](../command/CommandSender.md) to see if they can perform this_ | `boolean`
...
Get | Description
--- | --- 
[`Command`](../command/Command.md) | this command object, for chaining
...
Argument | Type | Description  
--- | --- | --- 
sender | [`CommandSender`](../command/CommandSender.md) | Source object which is executing this command
...
Argument | Type | Description  
--- | --- | --- 
commandMap | [`CommandMap`](../command/CommandMap.md) | the CommandMap to register this command to
...
_Tests the given [`CommandSender`](../command/CommandSender.md) to see if they can perform this command. <p> If they do not have permission, they will be informed that they cannot do this._

Argument | Type | Description  
--- | --- | --- 
target | [`CommandSender`](../command/CommandSender.md) | User to test
...
_Tests the given [`CommandSender`](../command/CommandSender.md) to see if they can perform this command. <p> No error is sent to the sender._
...
Argument | Type | Description  
--- | --- | --- 
commandMap | [`CommandMap`](../command/CommandMap.md) | the CommandMap to unregister
