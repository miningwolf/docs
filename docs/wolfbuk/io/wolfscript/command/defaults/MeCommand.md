...
>io.wolfscript.command.defaults.MeCommand
...
Method | Type   
--- | :--- 
new __MeCommand__() <br> _MeCommand constructor_ | _constructor_
...
### Public Constructors for [`MeCommand`](MeCommand.md)

##### <a id='mecommand'></a>new __MeCommand__() 

_MeCommand constructor_


---

### Public Methods for [`MeCommand`](MeCommand.md)
