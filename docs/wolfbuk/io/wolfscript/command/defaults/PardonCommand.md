## PardonCommand __class__

>io.wolfscript.command.defaults.PardonCommand
...
Method | Type   
--- | :--- 
new __PardonCommand__() <br> _PardonCommand constructor_ | _constructor_
...
### Public Constructors for [`PardonCommand`](PardonCommand.md)

##### <a id='pardoncommand'></a>new __PardonCommand__() 

_PardonCommand constructor_


---

### Public Methods for [`PardonCommand`](PardonCommand.md)
