## KickCommand __class__

>io.wolfscript.command.defaults.KickCommand
...
Method | Type   
--- | :--- 
new __KickCommand__() <br> _KickCommand constructor_ | _constructor_
...
### Public Constructors for [`KickCommand`](KickCommand.md)

##### <a id='kickcommand'></a>new __KickCommand__() 

_KickCommand constructor_


---

### Public Methods for [`KickCommand`](KickCommand.md)
