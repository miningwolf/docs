## DefaultGameModeCommand __class__

>io.wolfscript.command.defaults.DefaultGameModeCommand
...
Method | Type   
--- | :--- 
new __DefaultGameModeCommand__() <br> _DefaultGameModeCommand constructor_ | _constructor_
...
### Public Constructors for [`DefaultGameModeCommand`](DefaultGameModeCommand.md)

##### <a id='defaultgamemodecommand'></a>new __DefaultGameModeCommand__() 

_DefaultGameModeCommand constructor_


---

### Public Methods for [`DefaultGameModeCommand`](DefaultGameModeCommand.md)
