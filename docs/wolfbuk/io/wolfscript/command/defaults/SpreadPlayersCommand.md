## SpreadPlayersCommand __class__

>io.wolfscript.command.defaults.SpreadPlayersCommand
...
Method | Type   
--- | :--- 
new __SpreadPlayersCommand__() <br> _SpreadPlayersCommand constructor_ | _constructor_
...
### Public Constructors for [`SpreadPlayersCommand`](SpreadPlayersCommand.md)

##### <a id='spreadplayerscommand'></a>new __SpreadPlayersCommand__() 

_SpreadPlayersCommand constructor_


---

### Public Methods for [`SpreadPlayersCommand`](SpreadPlayersCommand.md)
