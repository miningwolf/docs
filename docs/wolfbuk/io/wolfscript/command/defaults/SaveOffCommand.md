## SaveOffCommand __class__

>io.wolfscript.command.defaults.SaveOffCommand
...
Method | Type   
--- | :--- 
new __SaveOffCommand__() <br> _SaveOffCommand constructor_ | _constructor_
...
### Public Constructors for [`SaveOffCommand`](SaveOffCommand.md)

##### <a id='saveoffcommand'></a>new __SaveOffCommand__() 

_SaveOffCommand constructor_


---

### Public Methods for [`SaveOffCommand`](SaveOffCommand.md)
