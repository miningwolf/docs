## SpawnpointCommand __class__

>io.wolfscript.command.defaults.SpawnpointCommand
...
Method | Type   
--- | :--- 
new __SpawnpointCommand__() <br> _SpawnpointCommand constructor_ | _constructor_
...
### Public Constructors for [`SpawnpointCommand`](SpawnpointCommand.md)

##### <a id='spawnpointcommand'></a>new __SpawnpointCommand__() 

_SpawnpointCommand constructor_


---

### Public Methods for [`SpawnpointCommand`](SpawnpointCommand.md)
