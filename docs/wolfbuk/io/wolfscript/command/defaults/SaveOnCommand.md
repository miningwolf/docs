## SaveOnCommand __class__

>io.wolfscript.command.defaults.SaveOnCommand
...
Method | Type   
--- | :--- 
new __SaveOnCommand__() <br> _SaveOnCommand constructor_ | _constructor_
...
### Public Constructors for [`SaveOnCommand`](SaveOnCommand.md)

##### <a id='saveoncommand'></a>new __SaveOnCommand__() 

_SaveOnCommand constructor_


---

### Public Methods for [`SaveOnCommand`](SaveOnCommand.md)
