## StopCommand __class__

>io.wolfscript.command.defaults.StopCommand
...
Method | Type   
--- | :--- 
new __StopCommand__() <br> _StopCommand constructor_ | _constructor_
...
### Public Constructors for [`StopCommand`](StopCommand.md)

##### <a id='stopcommand'></a>new __StopCommand__() 

_StopCommand constructor_


---

### Public Methods for [`StopCommand`](StopCommand.md)
