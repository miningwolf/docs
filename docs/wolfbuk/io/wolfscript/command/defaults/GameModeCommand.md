## GameModeCommand __class__

>io.wolfscript.command.defaults.GameModeCommand
...
Method | Type   
--- | :--- 
new __GameModeCommand__() <br> _GameModeCommand constructor_ | _constructor_
...
### Public Constructors for [`GameModeCommand`](GameModeCommand.md)

##### <a id='gamemodecommand'></a>new __GameModeCommand__() 

_GameModeCommand constructor_


---

### Public Methods for [`GameModeCommand`](GameModeCommand.md)
