## TimingsCommand __class__

>io.wolfscript.command.defaults.TimingsCommand
...
Method | Type   
--- | :--- 
new __TimingsCommand__(name) <br> _TimingsCommand constructor_ | _constructor_
...
### Public Constructors for [`TimingsCommand`](TimingsCommand.md)

##### <a id='timingscommand'></a>new __TimingsCommand__(name) 

_TimingsCommand constructor_
...
### Public Methods for [`TimingsCommand`](TimingsCommand.md)
