## WeatherCommand __class__

>io.wolfscript.command.defaults.WeatherCommand
...
Method | Type   
--- | :--- 
new __WeatherCommand__() <br> _WeatherCommand constructor_ | _constructor_
...
### Public Constructors for [`WeatherCommand`](WeatherCommand.md)

##### <a id='weathercommand'></a>new __WeatherCommand__() 

_WeatherCommand constructor_


---

### Public Methods for [`WeatherCommand`](WeatherCommand.md)
