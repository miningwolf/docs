## DifficultyCommand __class__

>io.wolfscript.command.defaults.DifficultyCommand
...
Method | Type   
--- | :--- 
new __DifficultyCommand__() <br> _DifficultyCommand constructor_ | _constructor_
...
### Public Constructors for [`DifficultyCommand`](DifficultyCommand.md)

##### <a id='difficultycommand'></a>new __DifficultyCommand__() 

_DifficultyCommand constructor_


---

### Public Methods for [`DifficultyCommand`](DifficultyCommand.md)
