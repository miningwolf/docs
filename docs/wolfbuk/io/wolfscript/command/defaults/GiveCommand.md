## GiveCommand __class__

>io.wolfscript.command.defaults.GiveCommand
...
Method | Type   
--- | :--- 
new __GiveCommand__() <br> _GiveCommand constructor_ | _constructor_
...
### Public Constructors for [`GiveCommand`](GiveCommand.md)

##### <a id='givecommand'></a>new __GiveCommand__() 

_GiveCommand constructor_


---

### Public Methods for [`GiveCommand`](GiveCommand.md)
