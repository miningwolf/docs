## ListCommand __class__

>io.wolfscript.command.defaults.ListCommand
...
Method | Type   
--- | :--- 
new __ListCommand__() <br> _ListCommand constructor_ | _constructor_
...
### Public Constructors for [`ListCommand`](ListCommand.md)

##### <a id='listcommand'></a>new __ListCommand__() 

_ListCommand constructor_


---

### Public Methods for [`ListCommand`](ListCommand.md)
