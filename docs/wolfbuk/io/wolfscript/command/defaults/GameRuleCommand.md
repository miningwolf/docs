...
Method | Type   
--- | :--- 
new __GameRuleCommand__() <br> _GameRuleCommand constructor_ | _constructor_
...
### Public Constructors for [`GameRuleCommand`](GameRuleCommand.md)

##### <a id='gamerulecommand'></a>new __GameRuleCommand__() 

_GameRuleCommand constructor_


---

### Public Methods for [`GameRuleCommand`](GameRuleCommand.md)
