## TimeCommand __class__

>io.wolfscript.command.defaults.TimeCommand
...
Method | Type   
--- | :--- 
new __TimeCommand__() <br> _TimeCommand constructor_ | _constructor_
...
### Public Constructors for [`TimeCommand`](TimeCommand.md)

##### <a id='timecommand'></a>new __TimeCommand__() 

_TimeCommand constructor_


---

### Public Methods for [`TimeCommand`](TimeCommand.md)
