## ClearCommand __class__

>io.wolfscript.command.defaults.ClearCommand
...
Method | Type   
--- | :--- 
new __ClearCommand__() <br> _ClearCommand constructor_ | _constructor_
...
### Public Constructors for [`ClearCommand`](ClearCommand.md)

##### <a id='clearcommand'></a>new __ClearCommand__() 

_ClearCommand constructor_


---

### Public Methods for [`ClearCommand`](ClearCommand.md)
