## TellCommand __class__

>io.wolfscript.command.defaults.TellCommand
...
Method | Type   
--- | :--- 
new __TellCommand__() <br> _TellCommand constructor_ | _constructor_
...
### Public Constructors for [`TellCommand`](TellCommand.md)

##### <a id='tellcommand'></a>new __TellCommand__() 

_TellCommand constructor_


---

### Public Methods for [`TellCommand`](TellCommand.md)
