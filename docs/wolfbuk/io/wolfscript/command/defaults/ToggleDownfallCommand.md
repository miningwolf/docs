## ToggleDownfallCommand __class__

>io.wolfscript.command.defaults.ToggleDownfallCommand
...
Method | Type   
--- | :--- 
new __ToggleDownfallCommand__() <br> _ToggleDownfallCommand constructor_ | _constructor_
...
### Public Constructors for [`ToggleDownfallCommand`](ToggleDownfallCommand.md)

##### <a id='toggledownfallcommand'></a>new __ToggleDownfallCommand__() 

_ToggleDownfallCommand constructor_


---

### Public Methods for [`ToggleDownfallCommand`](ToggleDownfallCommand.md)
