## SaveCommand __class__

>io.wolfscript.command.defaults.SaveCommand
...
Method | Type   
--- | :--- 
new __SaveCommand__() <br> _SaveCommand constructor_ | _constructor_
...
### Public Constructors for [`SaveCommand`](SaveCommand.md)

##### <a id='savecommand'></a>new __SaveCommand__() 

_SaveCommand constructor_


---

### Public Methods for [`SaveCommand`](SaveCommand.md)
