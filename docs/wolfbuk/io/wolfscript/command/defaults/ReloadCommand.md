## ReloadCommand __class__

>io.wolfscript.command.defaults.ReloadCommand
...
Method | Type   
--- | :--- 
new __ReloadCommand__(name) <br> _ReloadCommand constructor_ | _constructor_
...
### Public Constructors for [`ReloadCommand`](ReloadCommand.md)

##### <a id='reloadcommand'></a>new __ReloadCommand__(name) 

_ReloadCommand constructor_
