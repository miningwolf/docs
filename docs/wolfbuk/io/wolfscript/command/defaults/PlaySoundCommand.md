## PlaySoundCommand __class__

>io.wolfscript.command.defaults.PlaySoundCommand
...
Method | Type   
--- | :--- 
new __PlaySoundCommand__() <br> _PlaySoundCommand constructor_ | _constructor_
...
### Public Constructors for [`PlaySoundCommand`](PlaySoundCommand.md)

##### <a id='playsoundcommand'></a>new __PlaySoundCommand__() 

_PlaySoundCommand constructor_


---

### Public Methods for [`PlaySoundCommand`](PlaySoundCommand.md)
