## KillCommand __class__

>io.wolfscript.command.defaults.KillCommand
...
Method | Type   
--- | :--- 
new __KillCommand__() <br> _KillCommand constructor_ | _constructor_
...
### Public Constructors for [`KillCommand`](KillCommand.md)

##### <a id='killcommand'></a>new __KillCommand__() 

_KillCommand constructor_


---

### Public Methods for [`KillCommand`](KillCommand.md)
