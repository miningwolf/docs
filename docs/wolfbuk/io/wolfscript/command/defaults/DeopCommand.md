## DeopCommand __class__

>io.wolfscript.command.defaults.DeopCommand
...
Method | Type   
--- | :--- 
new __DeopCommand__() <br> _DeopCommand constructor_ | _constructor_
...
### Public Constructors for [`DeopCommand`](DeopCommand.md)

##### <a id='deopcommand'></a>new __DeopCommand__() 

_DeopCommand constructor_


---

### Public Methods for [`DeopCommand`](DeopCommand.md)
