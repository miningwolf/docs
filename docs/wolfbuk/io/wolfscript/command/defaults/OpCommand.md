...
>io.wolfscript.command.defaults.OpCommand
...
Method | Type   
--- | :--- 
new __OpCommand__() <br> _OpCommand constructor_ | _constructor_
...
### Public Constructors for [`OpCommand`](OpCommand.md)

##### <a id='opcommand'></a>new __OpCommand__() 

_OpCommand constructor_


---

### Public Methods for [`OpCommand`](OpCommand.md)
