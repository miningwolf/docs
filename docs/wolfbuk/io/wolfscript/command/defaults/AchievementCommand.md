## AchievementCommand __class__

>io.wolfscript.command.defaults.AchievementCommand
...
Method | Type   
--- | :--- 
new __AchievementCommand__() <br> _AchievementCommand constructor_ | _constructor_
...
### Public Constructors for [`AchievementCommand`](AchievementCommand.md)

##### <a id='achievementcommand'></a>new __AchievementCommand__() 

_AchievementCommand constructor_


---

### Public Methods for [`AchievementCommand`](AchievementCommand.md)
