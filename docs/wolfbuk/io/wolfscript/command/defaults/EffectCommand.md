## EffectCommand __class__

>io.wolfscript.command.defaults.EffectCommand
...
Method | Type   
--- | :--- 
new __EffectCommand__() <br> _EffectCommand constructor_ | _constructor_
 function __execute__(sender, commandLabel) <br> _execute method_ | `boolean`
 function __tabComplete__(sender, commandLabel) <br> _tabComplete method_ | `List<String>`
 |
...
### Public Constructors for [`EffectCommand`](EffectCommand.md)

##### <a id='effectcommand'></a>new __EffectCommand__() 

_EffectCommand constructor_


---

### Public Methods for [`EffectCommand`](EffectCommand.md)
...
##### <a id='tabcomplete'></a>public  function __tabComplete__(sender, commandLabel)
