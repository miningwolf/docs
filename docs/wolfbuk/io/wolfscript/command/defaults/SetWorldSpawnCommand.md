## SetWorldSpawnCommand __class__

>io.wolfscript.command.defaults.SetWorldSpawnCommand
...
Method | Type   
--- | :--- 
new __SetWorldSpawnCommand__() <br> _SetWorldSpawnCommand constructor_ | _constructor_
...
### Public Constructors for [`SetWorldSpawnCommand`](SetWorldSpawnCommand.md)

##### <a id='setworldspawncommand'></a>new __SetWorldSpawnCommand__() 

_SetWorldSpawnCommand constructor_


---

### Public Methods for [`SetWorldSpawnCommand`](SetWorldSpawnCommand.md)
