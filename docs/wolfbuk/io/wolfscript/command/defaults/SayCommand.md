## SayCommand __class__

>io.wolfscript.command.defaults.SayCommand
...
Method | Type   
--- | :--- 
new __SayCommand__() <br> _SayCommand constructor_ | _constructor_
...
### Public Constructors for [`SayCommand`](SayCommand.md)

##### <a id='saycommand'></a>new __SayCommand__() 

_SayCommand constructor_


---

### Public Methods for [`SayCommand`](SayCommand.md)
