## WhitelistCommand __class__

>io.wolfscript.command.defaults.WhitelistCommand
...
Method | Type   
--- | :--- 
new __WhitelistCommand__() <br> _WhitelistCommand constructor_ | _constructor_
...
### Public Constructors for [`WhitelistCommand`](WhitelistCommand.md)

##### <a id='whitelistcommand'></a>new __WhitelistCommand__() 

_WhitelistCommand constructor_


---

### Public Methods for [`WhitelistCommand`](WhitelistCommand.md)
