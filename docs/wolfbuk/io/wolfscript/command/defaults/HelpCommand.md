...
Method | Type   
--- | :--- 
new __HelpCommand__() <br> _HelpCommand constructor_ | _constructor_
...
### Public Constructors for [`HelpCommand`](HelpCommand.md)

##### <a id='helpcommand'></a>new __HelpCommand__() 

_HelpCommand constructor_
