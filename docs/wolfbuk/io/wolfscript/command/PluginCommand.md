...
Method | Type   
--- | :--- 
  property __Executor__ <br> _Get: Gets the [`CommandExecutor`](CommandExecutor.md) associated with this command<br>Set: Sets the [`CommandExecutor`](CommandExecutor.md) to run when parsing this command_ | [`CommandExecutor`](CommandExecutor.md)
 readonly property __Plugin__ <br> _Get: Gets the owner of this PluginCommand_ | [`Plugin`](../plugin/Plugin.md)
  property __TabCompleter__ <br> _Get: Gets the [`TabCompleter`](TabCompleter.md) associated with this command.<br>Set: Sets the [`TabCompleter`](TabCompleter.md) to run when tab-completing this command._ | [`TabCompleter`](TabCompleter.md)
 function __execute__(sender, commandLabel) <br> _Executes the command, returning its success_ | `boolean`
...
##### <a id='executor'></a>public   property __Executor__

_Get: Gets the [`CommandExecutor`](CommandExecutor.md) associated with this command<br>Set: Sets the [`CommandExecutor`](CommandExecutor.md) to run when parsing this command_

Get | Description
--- | --- 
[`CommandExecutor`](CommandExecutor.md) | CommandExecutor object linked to this command

Set | Type | Description  
--- | --- | --- 
executor | [`CommandExecutor`](CommandExecutor.md) | New executor to run


##### <a id='plugin'></a>public  readonly property __Plugin__

_Get: Gets the owner of this PluginCommand_

Get | Description
--- | --- 
[`Plugin`](../plugin/Plugin.md) | Plugin that owns this command



##### <a id='tabcompleter'></a>public   property __TabCompleter__

_Get: Gets the [`TabCompleter`](TabCompleter.md) associated with this command.<br>Set: Sets the [`TabCompleter`](TabCompleter.md) to run when tab-completing this command. <p> If no TabCompleter is specified, and the command's executor implements TabCompleter, then the executor will be used for tab completion._

Get | Description
--- | --- 
[`TabCompleter`](TabCompleter.md) | TabCompleter object linked to this command

Set | Type | Description  
--- | --- | --- 
completer | [`TabCompleter`](TabCompleter.md) | New tab completer
