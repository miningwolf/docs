...
new __RedstoneWire__(Material) <br> _RedstoneWire constructor_ | _constructor_
...
##### <a id='redstonewire'></a>new __RedstoneWire__(int) 
...
##### <a id='redstonewire'></a>new __RedstoneWire__(Material) 
...
##### <a id='redstonewire'></a>new __RedstoneWire__(int, byte) 
_Deprecated: Magic value_
...
##### <a id='redstonewire'></a>new __RedstoneWire__(Material, byte) 
_Deprecated: Magic value_
