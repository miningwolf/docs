...
new __MonsterEggs__(Material) <br> _MonsterEggs constructor_ | _constructor_
...
##### <a id='monstereggs'></a>new __MonsterEggs__(int) 
...
##### <a id='monstereggs'></a>new __MonsterEggs__(Material) 
...
##### <a id='monstereggs'></a>new __MonsterEggs__(int, byte) 
_Deprecated: Magic value_
