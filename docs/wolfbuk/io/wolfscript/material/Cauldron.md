...
new __Cauldron__() <br> _Cauldron constructor_ | _constructor_
 ...
 function __isEmpty__() <br> _Check if the cauldron is empty._ | `boolean`
 function __isFull__() <br> _Check if the cauldron is full._ | `boolean`
...
##### <a id='cauldron'></a>new __Cauldron__(type, data) 
...
##### <a id='cauldron'></a>new __Cauldron__(data) 
_Deprecated: Magic value_
...
_Check if the cauldron is empty._

Returns | Description
--- | --- 
`boolean` | True if it is empty.


##### <a id='isfull'></a>public  function __isFull__()

_Check if the cauldron is full._
