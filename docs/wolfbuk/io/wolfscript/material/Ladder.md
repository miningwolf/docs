...
new __Ladder__(Material) <br> _Ladder constructor_ | _constructor_
 readonly property __AttachedFace__ <br> _Get: Gets the face that this block is attached on_ | [`BlockFace`](../block/BlockFace.md)
 writeonly property __FacingDirection__ <br> _Set: Sets the direction this ladder is facing_ | `void`
...
##### <a id='ladder'></a>new __Ladder__(int) 
...
##### <a id='ladder'></a>new __Ladder__(Material) 
...
##### <a id='ladder'></a>new __Ladder__(int, byte) 
_Deprecated: Magic value_
...
##### <a id='ladder'></a>new __Ladder__(Material, byte) 
_Deprecated: Magic value_
...
_Set: Sets the direction this ladder is facing_
