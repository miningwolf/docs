...
new __EnderChest__(direction) <br> _Instantiate an ender chest facing in a particular direction._ | _constructor_
new __EnderChest__(Material) <br> _EnderChest constructor_ | _constructor_
...
##### <a id='enderchest'></a>new __EnderChest__(direction) 

_Instantiate an ender chest facing in a particular direction._

Argument | Type | Description  
--- | --- | --- 
direction | [`BlockFace`](../block/BlockFace.md) | the direction the ender chest's lid opens towards

##### <a id='enderchest'></a>new __EnderChest__(int) 
...
##### <a id='enderchest'></a>new __EnderChest__(Material) 
...
##### <a id='enderchest'></a>new __EnderChest__(int, byte) 
_Deprecated: Magic value_
