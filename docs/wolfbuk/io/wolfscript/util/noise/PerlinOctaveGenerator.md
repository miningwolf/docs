...
Method | Type   
--- | :--- 
new __PerlinOctaveGenerator__(world, octaves) <br> _Creates a perlin octave generator for the given world_ | _constructor_
new __PerlinOctaveGenerator__(seed, octaves) <br> _Creates a perlin octave generator for the given world_ | _constructor_
new __PerlinOctaveGenerator__(rand, octaves) <br> _Creates a perlin octave generator for the given `Random`_ | _constructor_
 |
...
##### <a id='perlinoctavegenerator'></a>new __PerlinOctaveGenerator__(world, octaves) 
...
##### <a id='perlinoctavegenerator'></a>new __PerlinOctaveGenerator__(seed, octaves) 
...
_Creates a perlin octave generator for the given `Random`_
