...
Method | Type   
--- | :--- 
new __SimplexNoiseGenerator__(world) <br> _Creates a seeded simplex noise generator for the given world_ | _constructor_
new __SimplexNoiseGenerator__(seed) <br> _Creates a seeded simplex noise generator for the given seed_ | _constructor_
new __SimplexNoiseGenerator__(rand) <br> _Creates a seeded simplex noise generator with the given Random_ | _constructor_
static readonly property __Instance__ <br> _Get: Gets the singleton unseeded instance of this generator_ | [`SimplexNoiseGenerator`](SimplexNoiseGenerator.md)
static function __getNoise__(xin) <br> _Computes and returns the 1D unseeded simplex noise for the given_ | `double`
static function __getNoise__(xin, yin) <br> _Computes and returns the 2D unseeded simplex noise for the given_ | `double`
static function __getNoise__(xin, yin, zin) <br> _Computes and returns the 3D unseeded simplex noise for the given_ | `double`
static function __getNoise__(x, y, z, w) <br> _Computes and returns the 4D simplex noise for the given coordinates in_ | `double`
 function __noise__(xin, yin, zin) <br> _noise method_ | `double`
 function __noise__(xin, yin) <br> _noise method_ | `double`
 function __noise__(x, y, z, w) <br> _Computes and returns the 4D simplex noise for the given coordinates in_ | `double`
 |
...
### Public Constructors for [`SimplexNoiseGenerator`](SimplexNoiseGenerator.md)

##### <a id='simplexnoisegenerator'></a>new __SimplexNoiseGenerator__(world) 

_Creates a seeded simplex noise generator for the given world_

Argument | Type | Description  
--- | --- | --- 
world | `World` | World to construct this generator for

##### <a id='simplexnoisegenerator'></a>new __SimplexNoiseGenerator__(seed) 

_Creates a seeded simplex noise generator for the given seed_

Argument | Type | Description  
--- | --- | --- 
seed | `long` | Seed to construct this generator for

##### <a id='simplexnoisegenerator'></a>new __SimplexNoiseGenerator__(rand) 

_Creates a seeded simplex noise generator with the given Random_
...
Get | Description
--- | --- 
[`SimplexNoiseGenerator`](SimplexNoiseGenerator.md) | Singleton



---

### Public Methods for [`SimplexNoiseGenerator`](SimplexNoiseGenerator.md)

##### <a id='getnoise'></a>public static function __getNoise__(xin)

_Computes and returns the 1D unseeded simplex noise for the given coordinates in 1D space_

Argument | Type | Description  
--- | --- | --- 
xin | `double` | X coordinate
...
##### <a id='getnoise'></a>public static function __getNoise__(xin, yin)

_Computes and returns the 2D unseeded simplex noise for the given coordinates in 2D space_

Argument | Type | Description  
--- | --- | --- 
xin | `double` | X coordinate
yin | `double` | Y coordinate
...
##### <a id='getnoise'></a>public static function __getNoise__(xin, yin, zin)

_Computes and returns the 3D unseeded simplex noise for the given coordinates in 3D space_

Argument | Type | Description  
--- | --- | --- 
xin | `double` | X coordinate
yin | `double` | Y coordinate
zin | `double` | Z coordinate
...
##### <a id='getnoise'></a>public static function __getNoise__(x, y, z, w)

_Computes and returns the 4D simplex noise for the given coordinates in 4D space_
...
##### <a id='noise'></a>public  function __noise__(xin, yin, zin)

_noise method_

Argument | Type | Description  
--- | --- | --- 
xin | `double` | xin argument
yin | `double` | yin argument
zin | `double` | zin argument
...
##### <a id='noise'></a>public  function __noise__(xin, yin)
...
##### <a id='noise'></a>public  function __noise__(x, y, z, w)
