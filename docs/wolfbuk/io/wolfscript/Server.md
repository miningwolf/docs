...
--- | :--- 
 ...
 function __createChunkData__(world) <br> _Create a ChunkData for use in a generator._ | `ChunkData`
...
##### <a id='createchunkdata'></a>public  function __createChunkData__(world)
