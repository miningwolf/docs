...
new __EntityEvent__(Entity) <br> _EntityEvent constructor_ | _constructor_
 readonly property __EntityType__ <br> _Get: Returns the Entity involved in this event_ | [`EntityType`](io\wolfscript\entity\EntityType.md)
 |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 ...
 readonly property __Slot__ <br> _Get: Returns the item held by the player. If this Item is null and the armor stand Item is also null,_ | [`EquipmentSlot`](io\wolfscript\inventory\EquipmentSlot.md)
 |
...
new __BlockPistonEvent__(Block, BlockFace) <br> _BlockPistonEvent constructor_ | _constructor_
 readonly property __Direction__ <br> _Get: Returns true if the Piston in the event is sticky._ | [`BlockFace`](io\wolfscript\block\BlockFace.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`BlockEvent`](io\wolfscript\event\block\BlockEvent.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Initiator__ <br> _Get: Gets the Inventory that the ItemStack is being taken from_ | [`Inventory`](io\wolfscript\inventory\Inventory.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`Event`](io\wolfscript\event\Event.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Type__ <br> _Get: Gets all items to be added to the inventory in this drag._ | [`DragType`](io\wolfscript\event\inventory\DragType.md)
 |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __PigZombie__ <br> _Get: Gets the bolt which is striking the pig._ | [`PigZombie`](io\wolfscript\entity\PigZombie.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`EntityEvent`](io\wolfscript\event\entity\EntityEvent.md)__ |
...
Method | Type   
--- | :---: 
new __BlockPistonExtendEvent__(Block, int, BlockFace) <br> _BlockPistonExtendEvent constructor_ | _constructor_
new __BlockPistonExtendEvent__(Block, List, BlockFace) <br> _BlockPistonExtendEvent constructor_ | _constructor_
 readonly property __Blocks__ <br> _Get: Get the amount of blocks which will be moved while extending._ | `List<Block>`
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 |
__Inherited items from [`BlockPistonEvent`](io\wolfscript\event\block\BlockPistonEvent.md)__ |
...
new __PlayerBucketEvent__(Player, Block, BlockFace, Material, ItemStack) <br> _PlayerBucketEvent constructor_ | _constructor_
 readonly property __BlockFace__ <br> _Get: Returns the bucket used in this event_ | [`BlockFace`](io\wolfscript\block\BlockFace.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Recipients__ <br> _Recipients property_ | `Set<Player>`
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Lines__ <br> _Get: Gets the player changing the sign involved in this event._ | `String[]`
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`BlockEvent`](io\wolfscript\event\block\BlockEvent.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __JoinMessage__ <br> _Set: Gets the join message to send to all online players_ | `void`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
new __PlayerEvent__(Player) <br> _PlayerEvent constructor_ | _constructor_
final readonly property __Player__ <br> _Get: Returns the player involved in this event_ | `Player`
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Remaining__ <br> _Get: Gets the Item picked up by the player._ | `int`
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Item__ <br> _Get: Gets the Inventory that picked up the item_ | [`Item`](io\wolfscript\entity\Item.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`Event`](io\wolfscript\event\Event.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 writeonly property __Note__ <br> _Set: Gets the [`Instrument`](io\wolfscript\Instrument.md) to be used._ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`BlockEvent`](io\wolfscript\event\block\BlockEvent.md)__ |
new __BlockEvent__(Block) <br> _BlockEvent constructor_ | _constructor_
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __ToBlock__ <br> _Get: Gets the BlockFace that the block is moving to._ | [`Block`](io\wolfscript\block\Block.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`BlockEvent`](io\wolfscript\event\block\BlockEvent.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Map__ <br> _Get: Gets the map initialized in this event._ | `MapView`
 |
__Inherited items from [`ServerEvent`](io\wolfscript\event\server\ServerEvent.md)__ |
 |
__Inherited items from [`Event`](io\wolfscript\event\Event.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Sender__ <br> _Get: Gets the command that the user is attempting to execute from the_ | [`CommandSender`](io\wolfscript\command\CommandSender.md)
 |
__Inherited items from [`ServerEvent`](io\wolfscript\event\server\ServerEvent.md)__ |
 |
__Inherited items from [`Event`](io\wolfscript\event\Event.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 writeonly property __Item__ <br> _Item property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
new __PlayerEvent__(Player) <br> _PlayerEvent constructor_ | _constructor_
...
Called when a block is formed by entities. <p> Examples: <ul> <li>Snow formed by a [`entity.Snowman`](io\wolfscript\entity\Snowman.md). </ul>
...
Called when a block spreads based on world conditions. <p> Use [`block.BlockFormEvent`](io\wolfscript\event\block\BlockFormEvent.md) to catch blocks that "randomly" form instead of actually spread. <p> Examples: <ul> <li>Mushrooms spreading. <li>Fire spreading. </ul> <p> If a Block Spread event is cancelled, the block will not spread.
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __QuitMessage__ <br> _Set: Gets the quit message to send to all online players_ | `void`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
new __PlayerEvent__(Player) <br> _PlayerEvent constructor_ | _constructor_
final readonly property __Player__ <br> _Get: Returns the player involved in this event_ | `Player`
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 writeonly property __Yield__ <br> _Set: Returns the list of blocks that would have been removed or were removed_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`EntityEvent`](io\wolfscript\event\entity\EntityEvent.md)__ |
new __EntityEvent__(Entity) <br> _EntityEvent constructor_ | _constructor_
...
Method | Type   
--- | :---: 
 readonly property __ChangedType__ <br> _ChangedType property_ | [`Material`](io\wolfscript\Material.md)
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
...
new __InventoryClickEvent__(view, type, slot, click, action, key) <br> _InventoryClickEvent constructor_ | _constructor_
 readonly property __Click__ <br> _Get: Gets the type of slot that was clicked._ | [`ClickType`](io\wolfscript\event\inventory\ClickType.md)
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 |
__Inherited items from [`InventoryInteractEvent`](io\wolfscript\event\inventory\InventoryInteractEvent.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __PortalType__ <br> _Get: Gets a list of all blocks associated with the portal._ | [`PortalType`](io\wolfscript\PortalType.md)
 |
__Inherited items from [`EntityEvent`](io\wolfscript\event\entity\EntityEvent.md)__ |
new __EntityEvent__(Entity) <br> _EntityEvent constructor_ | _constructor_
 readonly property __EntityType__ <br> _Get: Returns the Entity involved in this event_ | [`EntityType`](io\wolfscript\entity\EntityType.md)
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __NewSlot__ <br> _Get: Gets the previous held slot index_ | `int`
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
...
Method | Type   
--- | :---: 
 readonly property __AnimationType__ <br> _Get: Construct a new PlayerAnimation event_ | [`PlayerAnimationType`](io\wolfscript\event\player\PlayerAnimationType.md)
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Burning__ <br> _Set: Gets the block for the furnace involved in this event_ | `void`
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`BlockEvent`](io\wolfscript\event\block\BlockEvent.md)__ |
...
__Inherited items from [`ChunkEvent`](io\wolfscript\event\world\ChunkEvent.md)__ |
 readonly property __Chunk__ <br> _Get: Gets the chunk being loaded/unloaded_ | [`Chunk`](io\wolfscript\Chunk.md)
 |
__Inherited items from [`WorldEvent`](io\wolfscript\event\world\WorldEvent.md)__ |
new __WorldEvent__(World) <br> _WorldEvent constructor_ | _constructor_
 readonly property __World__ <br> _Get: Gets the world primarily involved with this event_ | `World`
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 writeonly property __Duration__ <br> _Duration property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`EntityEvent`](io\wolfscript\event\entity\EntityEvent.md)__ |
new __EntityEvent__(Entity) <br> _EntityEvent constructor_ | _constructor_
...
new __HangingPlaceEvent__(Hanging, Player, Block, BlockFace) <br> _HangingPlaceEvent constructor_ | _constructor_
 readonly property __BlockFace__ <br> _Get: Returns the player placing the hanging entity_ | [`BlockFace`](io\wolfscript\block\BlockFace.md)
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Material__ <br> _Get: Gets the statistic that is being incremented._ | [`Material`](io\wolfscript\Material.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __NewLevel__ <br> _Get: Gets the old level of the player_ | `int`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
new __PlayerEvent__(Player) <br> _PlayerEvent constructor_ | _constructor_
final readonly property __Player__ <br> _Get: Returns the player involved in this event_ | `Player`
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Cancelled__ <br> _Cancelled property_ | `void`
 writeonly property __Velocity__ <br> _Set: Gets the item that is being dispensed. Modifying the returned item will_ | `void`
 function __isCancelled__() <br> _isCancelled method_ | `boolean`
 |
__Inherited items from [`BlockEvent`](io\wolfscript\event\block\BlockEvent.md)__ |
new __BlockEvent__(Block) <br> _BlockEvent constructor_ | _constructor_
...
static readonly property __HandlerList__ <br> _HandlerList property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 readonly property __Handlers__ <br> _Handlers property_ | [`HandlerList`](io\wolfscript\event\HandlerList.md)
 writeonly property __Amount__ <br> _Set: Get the amount of experience the player will receive_ | `void`
 |
__Inherited items from [`PlayerEvent`](io\wolfscript\event\player\PlayerEvent.md)__ |
new __PlayerEvent__(Player) <br> _PlayerEvent constructor_ | _constructor_
final readonly property __Player__ <br> _Get: Returns the player involved in this event_ | `Player`
